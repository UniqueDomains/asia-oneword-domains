...
> **Important:** this repository is a **public 7,412-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **7,417 domains** on the canonical page below.

**Public extract:** 7,412 rows · **Live catalog:** 7,417 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/asia?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_asia_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/asia?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_asia_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./asia.csv">CSV</a> / <a href="./asia.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_asia_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_asia_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .ASIA search](https://unique.domains/domains/tld/asia?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_asia_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .ASIA search](https://unique.domains/domains/tld/asia?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_asia_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./asia.csv) or [Download JSON](./asia.json)
...
- `asia.csv` — public CSV extract (7,412 rows)
- `asia.json` — public JSON extract (7,412 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,412-row public sample | 7,417 live domains                               |
