...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C393%20rows-8250df">
...
> **Important:** this repository is a **public 7,393-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **7,394 domains** on the canonical page below.

**Public extract:** 7,393 rows · **Live catalog:** 7,394 domains
...
- `asia.csv` — public CSV extract (7,393 rows)
- `asia.json` — public JSON extract (7,393 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,393-row public sample | 7,394 live domains                               |
